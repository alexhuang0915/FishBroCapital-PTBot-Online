...
export function loadAllStrategies(basePath, searchPaths = []) {
  ...
  const strategyFiles = [
    ...
    { file: 'TWF.MXF HOT  TXF_DX_60 策略回測績效報告.csv', name: 'MXF_DX_60', currency: 'TWD' },
    { file: 'TWF.MXF HOT  TXF_VIX_120 策略回測績效報告.csv', name: 'MXF_VIX_120', currency: 'TWD' },
    { file: 'TWF.MXF HOT  TXF_VIX_60 策略回測績效報告.csv', name: 'MXF_VIX_60', currency: 'TWD' },
  ];
